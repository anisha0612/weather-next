	...
	return (
		<div className="min-h-screen bg-[#0b0f17] text-white">
			...
			<div className="relative overflow-hidden px-4 py-10 sm:px-6 lg:px-8 lg:py-12">
				<div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(90,102,255,0.14),_transparent_34%),radial-gradient(circle_at_bottom_right,_rgba(244,216,107,0.08),_transparent_22%)]" />
				...
				<main className="relative mx-auto flex min-h-[calc(100vh-7rem)] w-full max-w-5xl items-center justify-center">
					<section className="w-full rounded-[32px] border border-white/5 bg-[radial-gradient(circle_at_top,_rgba(90,102,255,0.08),_transparent_35%),linear-gradient(180deg,_rgba(11,15,23,0.98),_rgba(9,12,18,0.98))] px-6 py-14 text-center shadow-[0_40px_120px_rgba(0,0,0,0.45)] backdrop-blur-sm sm:px-10 lg:px-16">
